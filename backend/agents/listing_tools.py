...
def score_return_risk(listing: str, category: str) -> dict:
    """Scores the listing against category_benchmarks.json. Pass the actual JSON string of the listing content generated by generate_listing_content (e.g. the string representation of the generated dictionary). You MUST pass the actual generated content, NOT a placeholder name like 'final_listing' or 'generated_listing'."""
    ...
    for item in category_issues:
        ...
        if "size_chart" in issue_id:
            chart = listing_dict.get("size_chart")
            ...
            material_val = listing_dict.get("material", "") or listing_dict.get("fabric", "")
